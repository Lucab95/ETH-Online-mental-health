...
async def main() -> None:
    ...
    {'program_id': '335JVni4rTnMjsayLJWowZixkMcDaTR22KpffqxGrEC6XvEmqEeWcDeBEXdMrYJiieNXewn9JmZDeTatA77iaaw8/mental_main', 'model_store_id': 'f671e23d-aaec-4808-902e-673151f4a9e9', 'model_provider_party_id': '12D3KooWAPEdktHBstxKxTSpb4zzCK1o8pzSG5Ab11WzP3VC1X9C'}

    # Provider 
    # User 
    # compute_bindings <builtins.ProgramBindings object at 0x349d333f0>
    # Computing using program 335JVni4rTnMjsayLJWowZixkMcDaTR22KpffqxGrEC6XvEmqEeWcDeBEXdMrYJiieNXewn9JmZDeTatA77iaaw8/mental_main
    # Use secret store_id: , 
    # Getting quote for operation...
    # Quote cost is 5660 unil

    program_id = '5y21RJMFLN3XWrkfcgnDLcYjA5BqLz67AFj1KoH5EidMBoaMhy1H7MwnygmVeSs69LpWjmFx1FJKKCF3xmibdvyZ/mental_main'
    
    creator = "12D3KooWAPEdktHBstxKxTSpb4zzCK1o8pzSG5Ab11WzP3VC1X9C"
    model_client = TorchClient(model)
    
    permissions = nillion.Permissions.default_for_user(creator)

    permissions.add_compute_permissions({model_provider_client.user_id: {program_id}})

    permissions.add_compute_permissions({creator: {program_id}})  # If `creator` is a different party

    # permissions.add_compute_permissions({creator: {program_id}})

    model_store_id = "f671e23d-aaec-4808-902e-673151f4a9e9"
    ...
    print('about to store input screts')
    ...
    compute_bindings.add_input_party("Provider", creator)
